...
use ProjectBundle\Entity\Service;
...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $services = $em->getRepository('ProjectBundle:Service')->findAll();
    ...
    {
        $service = new Service();
        $form = $this->createForm('ProjectBundle\Form\ServiceType', $service);
    ...
    {
        $deleteForm = $this->createDeleteForm($service);
        $editForm = $this->createForm('ProjectBundle\Form\ServiceType', $service);
